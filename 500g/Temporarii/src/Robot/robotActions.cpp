...
RobotActions::RobotActions(MotorDriver* blDriver, MotorDriver* flDriver,
                           MotorDriver* frDriver, MotorDriver* brDriver) {
...
void RobotActions::ArcLeft(int spd) {
  flDriver->setDirection(0);
  flDriver->setSpeed(spd / 2);

  blDriver->setDirection(0);
  blDriver->setSpeed(spd / 2);
...
void RobotActions::ArcRight(int spd) {
  flDriver->setDirection(0);
  flDriver->setSpeed(spd);
  ...
  frDriver->setDirection(0);
  frDriver->setSpeed(spd / 2);

  brDriver->setDirection(0);
  brDriver->setSpeed(spd / 2);
}
