...
// {
//     //Serial.println("-- GET DATA CALLED --");
//     // - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
//     {
//         Serial.println("CHECKING IF STREAM AVAILABLE");
//         if( !(*pStream).available())
//         {
//             Serial.println("STREAM NOT AVAILABLE");
//             // Stop reading if nothing there on first attempt
//             status = TFMP_HEADER;
//             return false;
//         }
//         else
...
//         //old code for timeout, replaced by first part of above if statement
