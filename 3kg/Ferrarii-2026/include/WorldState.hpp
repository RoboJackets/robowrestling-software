...
enum OpponentPositionEnum{FRONT_CLOSE, FRONT_FAR, REALLY_CLOSE_LEFT, REALLY_CLOSE_RIGHT, CLOSE_LEFT, MID_LEFT, FAR_LEFT, CLOSE_RIGHT, MID_RIGHT, FAR_RIGHT, BEHIND, NOT_SEEN};
