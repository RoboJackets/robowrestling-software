...
void RFM69::setMode(uint8_t newMode)
{
  ...
  switch (newMode) {
    ...
    case RF69_MODE_STANDBY:
      //Serial.println("setMode Standby");
      writeReg(REG_OPMODE, (readReg(REG_OPMODE) & 0xE3) | RF_OPMODE_STANDBY);
      //Serial.println("setMode Standby Done");
      break;
  ...
  //Serial.println("setMode While Loop");
...
{
  //Serial.println("Entered send frame");
  ...
  //Serial.println("Done writing to FIFO");
  ...
  //Serial.println("Finish set mode 1");
