...
RobotPhysicsUpdaterDEBUG::RobotPhysicsUpdaterDEBUG() {

}

void RobotPhysicsUpdaterDEBUG::update(std::shared_ptr<Robot> r1, std::vector<int> r1_update, std::shared_ptr<Robot> r2, std::vector<int> r2_update, double duration) {
...
bool RobotPhysicsUpdaterDEBUG::check_collision(std::shared_ptr<Robot> r1, std::shared_ptr<Robot> r2) {
...
void RobotPhysicsUpdaterDEBUG::sat_test(pdd normal_axis, std::vector<pdd> corners, double& min_along, double& max_along) {
	min_along = INT16_MAX;
	max_along = INT16_MIN;
...
double RobotPhysicsUpdaterDEBUG::dot_product(pdd first, pdd second) {
	return first.first * second.first + first.second * second.second;
}

bool RobotPhysicsUpdaterDEBUG::overlaps(double min_1, double max_1, double min_2, double max_2) {
  return is_between_ordered(min_2, min_1, max_1) || is_between_ordered(min_1, min_2, max_2) ;
}

bool RobotPhysicsUpdaterDEBUG::is_between_ordered(double val, double lower_bound, double upper_bound) {
  return lower_bound <= val && val <= upper_bound ;
}

void RobotPhysicsUpdaterDEBUG::collision_handler(std::shared_ptr<Robot> r1, std::shared_ptr<Robot> r2) {
...
void RobotPhysicsUpdaterDEBUG::move_robot(std::shared_ptr<Robot> r, double left_wheel, double right_wheel, double duration) {
